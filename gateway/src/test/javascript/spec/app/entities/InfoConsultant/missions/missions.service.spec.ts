...
describe('Service Tests', () => {
    describe('Missions Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MissionsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'infoconsultant/api/missions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Missions', () => {
                service.create(new Missions(null)).subscribe(received => {
            ...
            it('should update a Missions', () => {
                service.update(new Missions(123)).subscribe(received => {
