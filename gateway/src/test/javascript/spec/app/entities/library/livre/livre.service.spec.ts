    ...
    describe('Livre Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'library/api/livres';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Livre', () => {
                service.create(new Livre(null)).subscribe(received => {
            ...
            it('should update a Livre', () => {
                service.update(new Livre(123)).subscribe(received => {
