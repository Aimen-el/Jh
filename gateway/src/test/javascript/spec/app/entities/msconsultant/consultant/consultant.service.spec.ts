    ...
    describe('Consultant Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'msconsultant/api/consultants';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Consultant', () => {
                service.create(new Consultant(null)).subscribe(received => {
            ...
            it('should update a Consultant', () => {
                service.update(new Consultant(123)).subscribe(received => {
