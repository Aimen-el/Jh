...
import com.leanovia.consultant.service.UserService;
import com.leanovia.consultant.service.dto.UserDTO;
import com.leanovia.consultant.web.rest.util.PaginationUtil;
...
public class UserResource {
    ...
    @GetMapping("/users")
    @Timed
    public ResponseEntity<List<UserDTO>> getAllUsers(Pageable pageable,        OAuth2Authentication authentication) {
        ...
        if (authorized) {
            ...
            return  new ResponseEntity<>(page.getContent(),headers,HttpStatus.FORBIDDEN);
        }
    }
    @GetMapping("/auth")
    @Timed
    ...
    public String getAll() {
        ...
        return "from the consultant MS ! "+users.toString();
    }
